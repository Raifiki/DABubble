...
export class EditchannelComponent {
  ...
  async removeUserFromChannel(){
    this.channel.members = this.channel.members.filter(member => this.activeUser.id != member.id);
  ...
  addLeaveMessageToChannel(){
    ...
    this.messageService.addMessageToCollection('Channels',this.channel.id,leaveMessage);
  }

  async removeChannelFromUser(){
    this.activeUser.channelIDs = this.activeUser.channelIDs.filter(channelId => this.channel.id != channelId);
